...
// FIX: Corrected imports to use `import * as` syntax to ensure proper type resolution for CommonJS modules.
...
// If a production frontend URL is provided in environment variables, add it to the whitelist.
...
const corsOptions = {
  origin: (
    ...
    // Allow requests with no origin (like server-to-server, REST tools) or from whitelisted origins.
...
app.post(
  ...
  async (
    req: {
      body: { name: any; phone: any; email: any; birthday: any; vehicles: any };
    },
    res: {
      status: (arg0: number) => {
        (): any;
...
app.put(
  ...
  async (
    req: {
      params: { id: any };
      body: { name: any; phone: any; email: any; birthday: any };
    },
    res: {
      json: (arg0: any) => void;
      status: (arg0: number) => {
...
app.post(
  ...
  async (
    req: {
      body: { name: any; supplier: any; cost: any; stock: any; minStock: any };
    },
    res: {
      status: (arg0: number) => {
        (): any;
...
app.put(
  "/api/services/:id",
  async (
    req: { body: { name: any; price: any }; params: { id: any } },
    res: {
      json: (arg0: any) => void;
      status: (arg0: number) => {
        (): any;
...
app.get(
  ...
  async (
    ...
    try {
      ...
      const formatted = workOrders.map((wo: { services: any }) => ({
        ...wo,
...
app.put(
  ...
  async (
    req: {
      params: { id: any };
      body: { status: any; isPaid: any; paymentMethod: any };
    },
    res: {
      json: (arg0: any) => void;
      status: (arg0: number) => {
...
app.post(
  "/api/expenses",
  async (
    req: { body: { description: any; category: any; amount: any; date: any } },
    res: {
      status: (arg0: number) => {
        (): any;
        new (): any;
...
app.put(
  ...
  async (
    req: {
      body: { description: any; category: any; amount: any; date: any };
      params: { id: any };
    },
    res: {
      json: (arg0: any) => void;
...
app.get(
  ...
  async (
    ...
    res: {
      json: (
        arg0: { name: string; Receitas: number; Custos: number }[]
      ) => void;
      status: (arg0: number) => {
        (): any;
        new (): any;
